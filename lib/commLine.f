!
! $Date: 2012-06-15 18:58:01 $
! $Id: commLine.f,v 1.1 2012-06-15 18:58:01 gelpi Exp $
! $Revision: 1.1 $
!
MODULE commLine
...
subroutine writeHelpText (opts)
 ...
 integer i
 write (0,*) "Usage:"
 write (0,'(2X,A10,A15,A50)') (opts(i)%descr, opts(i)%filename, opts(i)%help, i=1,ubound(opts,1))
 write (0,*)
